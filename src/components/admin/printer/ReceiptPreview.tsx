  ...
  return (
    <div className="flex w-full min-w-0 justify-center py-2 px-1">
      <article
        ...
        className="receipt-preview relative h-fit w-full min-w-0 overflow-hidden border border-black/15 bg-[#fffef9] px-4 sm:px-5.5 pt-5 pb-3 font-mono text-[11px] sm:text-[11.5px] leading-[1.45] text-[#141414] shadow-[0_20px_50px_-20px_rgba(46,34,24,0.35),0_3px_12px_rgba(46,34,24,0.08)] select-text"
      >
