...
export function ChangelogHero({
  ...
  return (
    <header className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-4 border-b border-border/50">
      <div className="space-y-1 min-w-0">
        <div className="flex items-center gap-2.5 flex-wrap">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-heading text-foreground tracking-tight">
            Changelog
          </h1>
          {unseenCount > 0 && (
            <Badge className="bg-cinnamon hover:bg-cinnamon/90 text-white font-bold text-[10px] px-2.5 py-0.5 rounded-full shadow-2xs animate-pulse">
              {unseenCount} new
            </Badge>
          )}
        </div>
      ...
      <div className="flex items-center gap-2 text-xs text-muted-foreground self-start sm:self-auto shrink-0 pb-1">
