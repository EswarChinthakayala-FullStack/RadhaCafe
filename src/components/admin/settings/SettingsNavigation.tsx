            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`snap-start shrink-0 min-w-max flex items-center gap-2 px-4 py-2.5 rounded-md text-xs font-semibold transition-all border shadow-2xs active:scale-95 ${isActive
