...
const SIDEBAR_WIDTH_MOBILE = "13.5rem"
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="!w-[220px] !max-w-[220px] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full min-h-0 flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border overflow-hidden"
        >
          {children}
        </div>
      </div>
