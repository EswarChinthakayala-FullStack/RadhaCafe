...
export function PublicWaterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#07131B] text-slate-100 flex flex-col font-sans selection:bg-sky-500 selection:text-white">
      <Navbar />

      {/* Glassy Blue Hero Section */}
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden bg-gradient-to-b from-[#061723] via-[#0A2638] to-[#07131B] text-white border-b border-sky-900/40">
        {/* Ambient Glowing Glass Orbs */}
        <div className="absolute top-12 left-1/4 w-96 h-96 bg-sky-500/20 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-12 right-1/4 w-96 h-96 bg-cyan-400/15 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-5">
          ...
          {/* Glassmorphism Pricing Highlight Badges */}
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4">
            <div className="p-4 rounded-xl bg-sky-950/40 backdrop-blur-xl border border-sky-400/30 shadow-2xl text-left flex items-center gap-3.5 hover:border-sky-400/60 transition-all">
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-sky-500/20 to-cyan-500/20 text-sky-300 flex items-center justify-center font-bold text-xl border border-sky-400/30 shadow-inner">
                ₹{normalProduct.price}
              </div>
              <div>
                <p className="text-xs text-sky-400 font-bold uppercase tracking-wider font-heading">Normal 20L Can</p>
                <p className="text-sm font-extrabold text-white">{formatCurrency(normalProduct.price)} / Can</p>
              </div>
            </div>

            <div className="p-4 rounded-xl bg-cyan-950/40 backdrop-blur-xl border border-cyan-400/30 shadow-2xl text-left flex items-center gap-3.5 hover:border-cyan-400/60 transition-all">
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-cyan-500/20 to-blue-500/20 text-cyan-300 flex items-center justify-center font-bold text-xl border border-cyan-400/30 shadow-inner">
      ...
      <section className="py-16 bg-[#07131B] relative border-b border-sky-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border border-sky-500/20 bg-sky-950/20 backdrop-blur-md rounded-xl shadow-xl hover:border-sky-400/50 hover:bg-sky-900/30 transition-all">
              <CardContent className="p-6 space-y-3">
                <div className="w-12 h-12 rounded-xl bg-sky-500/20 text-sky-300 flex items-center justify-center border border-sky-400/30 shadow-inner">
            ...
            <Card className="border border-cyan-500/20 bg-cyan-950/20 backdrop-blur-md rounded-xl shadow-xl hover:border-cyan-400/50 hover:bg-cyan-900/30 transition-all">
              <CardContent className="p-6 space-y-3">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="h-10 text-xs bg-sky-950/50 border-sky-500/30 text-white placeholder:text-sky-200/40 rounded-lg focus:border-sky-400"
                  />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <Popover>
                    <PopoverTrigger
                      render={
                        <Button
                          variant="outline"
                          className="w-full h-10 justify-start text-xs bg-sky-950/50 border-sky-500/30 text-white rounded-lg gap-2 px-3 font-normal hover:bg-sky-900/40"
                        />
                      }
                    >
                      <HugeiconsIcon icon={Calendar01Icon} size={14} className="text-sky-400" />
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="h-10 text-xs bg-sky-950/50 border-sky-500/30 text-white rounded-lg font-bold"
                  />
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  rows={3}
                  {...register('notes')}
                  className="text-xs bg-sky-950/50 border-sky-500/30 text-white placeholder:text-sky-200/40 rounded-lg resize-none"
                />
              </div>
