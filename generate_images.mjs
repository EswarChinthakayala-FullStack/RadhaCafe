...
async function generateImages() {
  ...
  // The EXACT SVG code from AppLogo.tsx for 100% brand consistency
  const exactSvg = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width:100%; height:100%; display:block;">
      ...
      <text fill="#F7EBDC" font-size="56" font-weight="900" font-family="Georgia, 'Times New Roman', serif" letter-spacing="14">
        <textPath href="#rc-top-arc" startOffset="50%" text-anchor="middle">RADHA</textPath>
      </text>

      <text fill="#D9825B" font-size="22" font-weight="800" font-family="'Trebuchet MS', Arial, sans-serif" letter-spacing="6">
        <textPath href="#rc-bot-arc" startOffset="50%" text-anchor="middle">ESTD  2026</textPath>
      </text>
      ...
      <g clip-path="url(#rc-medal-clip)" stroke="#F7EBDC" stroke-width="1.5" opacity="0.25">
        <line x1="110" y1="135" x2="402" y2="135" />
        <line x1="110" y1="150" x2="402" y2="150" />
        <line x1="110" y1="165" x2="402" y2="165" />
        <line x1="110" y1="180" x2="402" y2="180" />
        <line x1="110" y1="195" x2="402" y2="195" />
        <line x1="110" y1="210" x2="402" y2="210" />
        <line x1="110" y1="225" x2="402" y2="225" />
        <line x1="110" y1="240" x2="402" y2="240" />
        <line x1="110" y1="255" x2="402" y2="255" />
        <line x1="110" y1="270" x2="402" y2="270" />
        <line x1="110" y1="285" x2="402" y2="285" />
        <line x1="110" y1="300" x2="402" y2="300" />
        <line x1="110" y1="315" x2="402" y2="315" />
      </g>
      ...
      <g stroke="#1F1009" stroke-width="1.5" opacity="0.3">
      ...
      <text fill="#1F1009" font-size="42" font-weight="900" font-family="'Trebuchet MS', 'Arial Black', sans-serif" letter-spacing="6">
        <textPath href="#rc-ribbon-arc" startOffset="50%" text-anchor="middle">COFFEE CAFE</textPath>
      </text>
    </svg>
  `;

  // 1. Generate Open Graph Social Sharing Banner (1200x630)
      ...
      <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body {
          width: 1200px;
          height: 630px;
          background: radial-gradient(circle at 60% 40%, #3A2016 0%, #170B06 70%, #0D0503 100%);
          display: flex;
          align-items: center;
    ...
    <body>
      <div class="content">
        ...
        <div class="features">
          ...
          <div class="feature-pill">🖨️ Thermal Receipts</div>
        </div>
      </div>
      <div class="logo-wrap">
        ${exactSvg}
  ...
  // 2. Generate 512x512 Square Logo PNG using exact SVG
    ...
    <head>
      <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo { width: 480px; height: 480px; filter: drop-shadow(0 8px 24px rgba(0,0,0,0.5)); }
      </style>
    </head>
    <body>
      <div class="logo">${exactSvg}</div>
    </body>
    </html>
  `;
  ...
  console.log('✓ Created public/logo.png, public/apple-touch-icon.png, public/favicon.png with exact SVG rendering!');
